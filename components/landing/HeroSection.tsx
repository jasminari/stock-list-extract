...
export default function HeroSection() {
  return (
    <section className="relative overflow-x-clip bg-gradient-to-b from-blue-50/60 via-white to-white">
          ...
          <div className="min-w-0">
            ...
            >
              ...
              <h1 className="text-5xl md:text-6xl font-extrabold text-gray-900 leading-[1.1] tracking-tight">
                오늘 오른 종목,
                <br />
                <span className="text-blue-600">왜 올랐는지</span>
                <br />
                까지 자동으로.
              </h1>
            ...
            >
              <Link
                href="/login"
                className="px-7 py-3.5 bg-blue-600 text-white font-semibold rounded-xl hover:bg-blue-700 transition-colors shadow-lg shadow-blue-600/20"
              >
                무료로 시작하기
              </Link>
              <Link
        ...
        {ROWS.map((row, i) => (
          ...
          >
            ...
            <div className="mt-2 flex items-start gap-2 min-w-0">
              <span className="shrink-0 text-[10px] font-semibold bg-blue-50 text-blue-600 rounded-full px-2 py-0.5">
                {row.keyword}
              </span>
