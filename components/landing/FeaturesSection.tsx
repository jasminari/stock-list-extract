        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {features.map((f, i) => (
            <Reveal key={i} delay={(i % 3) * 0.1}>
              <div className="h-full p-7 rounded-2xl border border-gray-100 hover:border-indigo-200 hover:shadow-lg hover:shadow-indigo-100/50 transition-all">
                ...
                <div className="flex items-center gap-2 mb-2">
                  ...
                  {f.badge && (
                    <span className="text-[10px] font-bold bg-indigo-600 text-white rounded px-1.5 py-0.5">
                      {f.badge}
                    </span>
                  )}
                </div>
