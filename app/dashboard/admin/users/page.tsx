      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-3 gap-3 mb-6">
          {[
            ...
            { label: "관리자", value: adminCount, color: "text-indigo-600" },
        ...
        <div className="bg-white border border-gray-200 rounded-xl overflow-hidden">
          <div className="px-4 py-3 border-b border-gray-200 flex items-center justify-between gap-3">
            ...
            <input
              ...
              className="w-52 px-3 py-1.5 bg-gray-100 border-0 rounded-lg text-xs focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-colors"
            />
          </div>
