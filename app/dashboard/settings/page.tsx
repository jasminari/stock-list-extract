...
export default function SettingsPage() {
  ...
  const { results, loading: resultsLoading, load: loadResults } = useResults();
  ...
  const handleSearch = async () => {
    await search.runSearch(cond.selectedSeq, cond.selectedName);
    loadResults();
  };
  ...
  return (
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-auto px-6 py-4">
        ...
        <div className="mt-6">
          <div className="flex items-center justify-between mb-3">
            <h3 className="text-sm font-medium text-gray-700">저장 이력</h3>
            <button
              onClick={loadResults}
          ...
          <HistoryPanel
            ...
            onDownload={search.downloadFile}
          />
        </div>
      </div>
    </div>
